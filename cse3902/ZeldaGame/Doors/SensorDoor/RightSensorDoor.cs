...
namespace ZeldaGame
{
    public class RightSensorDoor : GameObject, IDoor, IUpdatable, IDrawable, ICollidable
    {
        public String CollidableType { get; set; }
        public RightSensorDoor()
        {
            CollidableType = "Block"; // Originally collides like a block
            sprite = SpriteFactory.Instance.getSprite(Sprite.RightSensorDoor);
