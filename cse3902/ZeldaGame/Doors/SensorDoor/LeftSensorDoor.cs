...
namespace ZeldaGame
{
    public class LeftSensorDoor : GameObject, IDoor, IUpdatable, IDrawable, ICollidable
    {
        public String CollidableType { get; set; }
        public LeftSensorDoor()
        {
            CollidableType = "Block"; // Originally collides like a block
            sprite = SpriteFactory.Instance.getSprite(Sprite.LeftSensorDoor);
