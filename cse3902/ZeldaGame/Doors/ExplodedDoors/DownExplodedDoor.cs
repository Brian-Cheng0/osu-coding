...
namespace ZeldaGame
{
    public class DownExplodedDoor : GameObject, IDoor, IUpdatable, IDrawable, ICollidable
    {
        public String CollidableType { get; set; }
        public DownExplodedDoor()
        {
            CollidableType = "WalkableDoor";
            sprite = SpriteFactory.Instance.getSprite(Sprite.DownBoomedDoor); 
