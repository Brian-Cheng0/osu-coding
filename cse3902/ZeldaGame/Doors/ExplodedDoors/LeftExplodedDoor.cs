...
namespace ZeldaGame
{
    public class LeftExplodedDoor : GameObject, IDoor, IUpdatable, IDrawable, ICollidable
    {
        public String CollidableType { get; set; }
        public LeftExplodedDoor()
        {
            CollidableType = "WalkableDoor";
            sprite = SpriteFactory.Instance.getSprite(Sprite.LeftBoomedDoor);
