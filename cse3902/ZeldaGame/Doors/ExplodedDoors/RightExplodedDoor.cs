...
namespace ZeldaGame
{
    public class RightExplodedDoor : GameObject, IDoor, IUpdatable, IDrawable, ICollidable
    {
        public String CollidableType { get; set; }
        public RightExplodedDoor()
        {
            CollidableType = "WalkableDoor";
            sprite = SpriteFactory.Instance.getSprite(Sprite.RightBoomedDoor);
