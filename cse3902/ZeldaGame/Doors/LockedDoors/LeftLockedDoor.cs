...
namespace ZeldaGame
{
    public class LeftLockedDoor : GameObject, IDoor, IUpdatable, IDrawable, ICollidable
    {
        public String CollidableType { get; set; }
        public ISound Sound { get; set; }
        public LeftLockedDoor()
        {
            CollidableType = "LockedDoor"; // Originally collides like a block
            sprite = SpriteFactory.Instance.getSprite(Sprite.LeftLockedDoor);
        ...
        public void UnlockDoor()
        {
            ...
            if (UIManager.Instance.objToCount["Key"] > 0)
            {
                ...
                sprite = SpriteFactory.Instance.getSprite(Sprite.LeftNormalDoor);
