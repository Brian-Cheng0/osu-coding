...
{
    //Yuyang Pan
    public class MapItem : GameObject, IItem, IUpdatable, IDrawable, ICollidable
    {
        ...
        public MapItem()
        {
            ...
            sprite = SpriteFactory.Instance.getSprite(Sprite.Map);
        ...
        public void CollectItem()
        {
            ...
            UIManager.Instance.IncrementItemCount("Map");
            Sound.Play();
        }
        public void Impact()
        {
